...
public class BIDR implements Serializable{
	...
	public String toString() {
		return " \r \r BIDR [登入名=" + AAA_login_name + ",\r\t 登入Ip="
				+ login_ip + ",\r\t 上线时间=" + login_date + ",\r\t 下线时间="
				+ logout_date + ",\r\t NAS_ip=" + NAS_ip + ",\r\t 在线时长="
				+ time_deration + "秒]";
	}
